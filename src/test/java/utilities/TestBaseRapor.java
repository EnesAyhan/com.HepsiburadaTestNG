...
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        String filePath = System.getProperty("user.dir") + "/target/Rapor/rapor_"+date+"_.html";
    ...
    public void tearDownMethod(ITestResult result) throws IOException {
        ...
        } else if (result.getStatus() == ITestResult.SKIP) { // eğer test çalıştırılmadan geçildiyse
